...
class SimilarCodeTab:
    ...
    def __init__(self, visible=True):
        with gr.Tab(label="Similar Code", visible=visible) as self.tab:
            ...
            self.similar_code_notebook_url = gr.Text(visible=False)
            self.similar_code_notebook_url_markdown = gr.Markdown(visible=False)
            # show the intent of the similar code
            self.similar_intent = gr.Textbox(
                label="Similar Code Intent.", interactive=False, visible=False
            )
